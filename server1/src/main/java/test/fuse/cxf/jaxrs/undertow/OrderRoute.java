...
public class OrderRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("cxfrs:http://localhost:8080?resourceClasses=test.fuse.cxf.jaxrs.undertow.RestOrderService&bindingStyle=SimpleConsumer&providers=#jsonProvider")
